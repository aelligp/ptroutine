...
if Nx <= 10 && Nz <= 10  % create 0D plots
    ...
    fh1 = figure(1); 
    subplot(5,1,1)
    plot(hist.time/hr,hist.T(:,2),'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis xy tight; box on;
    title('$T [^\circ$C]',TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(5,1,2)
    plot(hist.time/hr,hist.cx(:,2)*100,'LineStyle', LS{i},'Color', LC{4},hist.time/hr,hist.cm(:,2)*100,'LineStyle', LS{i},'Color', LC{2},hist.time/hr,hist.c(:,2)./(1-hist.f(:,2))*100, 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis xy tight; box on;
    title('$\bar{c}/(1-f)$ [wt\% SiO$_2$]',TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(5,1,3)
    plot(hist.time/hr,hist.vm(:,2)*100,'LineStyle', LS{i},'Color', LC{1},hist.time/hr,hist.v(:,2)./(1-hist.x(:,2))*100, 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis xy tight; box on;
    title('$\bar{v}/(1-x)$ [wt\% H$_2$O]',TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(5,1,4)
    plot(hist.time/hr,hist.chi(:,2)*100.*(hist.chi(:,2)>1e-9),'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis xy tight; box on;
    title(['$\chi$ [vol\%]'],TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(5,1,5)
    plot(hist.time/hr,hist.phi(:,2)*100.*(hist.phi(:,2)>1e-9),'LineStyle', LS{i},'Color', LC{2},'LineWidth',2); axis xy tight; box on;
    ...
    subplot(5,1,1)
    plot(hist.time/hr,hist.rho(:,2), 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis xy tight; box on;
    title('$\bar{\rho}$ [kg/m$^3$]',TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(5,1,2)
    plot(hist.time/hr,log10(hist.etact(:,2)), 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis xy tight; box on;
    title('$\bar{\eta}$ [log$_{10}$ Pas]',TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(5,1,3)
    plot(hist.time/hr,hist.Gx(:,2)./hist.rho(:,2)*hr*100.*(hist.chi(:,2)>1e-9), 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis xy tight; box on;
    title('$\Gamma_x/\bar{\rho}$ [\%/hr]',TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(5,1,4)
    plot(hist.time/hr,hist.Gf(:,2)./hist.rho(:,2)*hr*100.*(hist.phi(:,2)>1e-9),'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis xy tight; box on;
    title('$\Gamma_f/\bar{\rho}$ [\%/hr]',TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(5,1,5)
    plot(hist.time/hr,hist.dV(:,2)*hr, 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis xy tight; box on;
    ...
    fh3 = figure(3);  
    subplot(5,1,1)
    plot(hist.time/hr,hist.it(:,2), 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis xy tight; box on;
    title('incomp. trace',TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(5,1,2)
    plot(hist.time/hr,hist.ct(:,2), 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis xy tight; box on;
    title('comp. trace',TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(5,1,3)
    plot(hist.time/hr,hist.si(:,2), 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis xy tight; box on;
    title('stable isotope',TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(5,1,4)
    plot(hist.time/hr,hist.rip(:,2), 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis xy tight; box on;
    title('radiogenic parent',TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(5,1,5)
    plot(hist.time/hr,hist.rid(:,2), 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis xy tight; box on;
...
elseif Nx <= 10  % create 1D plots
    ...
    fh1 = figure(1);
    subplot(1,5,1)
    plot(mean(T(2:end-1,2:end-1),2),Z(2:end-1).', 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis ij tight; box on;
    title('$T [^\circ$C]',TX{:},FS{:}); ylabel('Depth [m]',TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(1,5,2)
    plot(mean(cx(2:end-1,2:end-1),2)*100,Z(2:end-1).', 'LineStyle', LS{i},'Color', LC{3},mean(cm(2:end-1,2:end-1),2)*100,Z(2:end-1).', 'LineStyle', LS{i},'Color', LC{2},mean(c(2:end-1,2:end-1)./(1-f(2:end-1,2:end-1)),2)*100,Z(2:end-1).', 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis ij tight; box on;
    title('$\bar{c}/(1-f)$ [wt\%]',TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(1,5,3)
    plot(mean(vm(2:end-1,2:end-1),2)*100,Z(2:end-1).', 'LineStyle', LS{i},'Color', LC{2},mean(v(2:end-1,2:end-1)./(1-x(2:end-1,2:end-1)),2)*100,Z(2:end-1).', 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis ij tight; box on;
    title('$\bar{v}/(1-x)$ [wt\%]',TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(1,5,4)
    plot(mean(chi(2:end-1,2:end-1),2)*100.*(mean(chi(2:end-1,2:end-1),2)>1e-9),Z(2:end-1).', 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis ij tight; box on;
    title(['$\chi$ [vol\%]'],TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(1,5,5)
    plot(mean(phi(2:end-1,2:end-1),2)*100.*(mean(phi(2:end-1,2:end-1),2)>1e-9),Z(2:end-1).', 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis ij tight; box on;
    title(['$\phi$ [vol\%]'],TX{:},FS{:}); set(gca,TL{:},TS{:});

    fh2 = figure(2); 
    subplot(1,5,1)
    plot(mean(-W(:,2:end-1),2)*hr,Zfc.', 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis ij tight; box on;
    title('$W$ [m/hr]',TX{:},FS{:}); ylabel('Depth [m]',TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(1,5,2)
    plot(mean(-(x(1:end-1,2:end-1)+x(2:end,2:end-1))/2.*wx(:,2:end-1),2)*hr,Zfc.', 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis ij tight; box on;
    title('$w_\Delta^x$ [m/hr]',TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(1,5,3)
    plot(mean(-(f(1:end-1,2:end-1)+f(2:end,2:end-1))/2.*wf(:,2:end-1),2)*hr,Zfc.', 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis ij tight; box on;
    title('$w_\Delta^f$ [m/hr]',TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(1,5,4)
    plot(mean(-(m(1:end-1,2:end-1)+m(2:end,2:end-1))/2.*wm(:,2:end-1),2)*hr,Zfc.', 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis ij tight; box on;
    title('$w_\Delta^m$ [m/hr]',TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(1,5,5)
    plot(mean(P(2:end-1,2:end-1),2)/1e3,Z(2:end-1).', 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis ij tight; box on;
    title('$P$ [kPa]',TX{:},FS{:}); set(gca,TL{:},TS{:});

    fh3 = figure(3); 
    subplot(1,5,1)
    plot(mean(rho(2:end-1,2:end-1),2),Z(2:end-1).', 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis ij tight; box on;
    title('$\bar{\rho}$ [kg/m$^3$]',TX{:},FS{:}); ylabel('Depth [km]',TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(1,5,2)
    plot(mean(log10(etact(2:end-1,2:end-1)),2),Z(2:end-1).', 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis ij tight; box on;
    title('$\bar{\eta}$ [log$_{10}$ Pas]',TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(1,5,3)
    plot(mean(Gx(2:end-1,2:end-1)./rho(2:end-1,2:end-1),2)*100*hr.*(mean(chi(2:end-1,2:end-1),2)>1e-9),Z(2:end-1).', 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis ij tight; box on;
    title('$\Gamma_x/\bar{\rho}$ [\%/hr]',TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(1,5,4)
    plot(mean(Gf(2:end-1,2:end-1)./rho(2:end-1,2:end-1),2)*100*hr.*(mean(phi(2:end-1,2:end-1),2)>1e-9),Z(2:end-1).', 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis ij tight; box on;
    title('$\Gamma_f/\bar{\rho}$ [\%/hr]',TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(1,5,5)
    plot(mean(VolSrc(2:end-1,2:end-1),2),Z(2:end-1).', 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis ij tight; box on;
    title('$\dot{V}$ [1/hr]',TX{:},FS{:}); set(gca,TL{:},TS{:});

    fh4 = figure(4);  
    subplot(1,5,1)
    plot(mean(it(2:end-1,2:end-1),2),Z(2:end-1).', 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis ij tight; box on;
    title('incomp. trace',TX{:},FS{:}); ylabel('Depth [m]',TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(1,5,2)
    plot(mean(ct(2:end-1,2:end-1),2),Z(2:end-1).', 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis ij tight; box on;
    title('comp. trace',TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(1,5,3)
    plot(mean(si(2:end-1,2:end-1),2),Z(2:end-1).', 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis ij tight; box on;
    title('stable isotope',TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(1,5,4)
    plot(mean(rip(2:end-1,2:end-1),2),Z(2:end-1).', 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis ij tight; box on;
    title(['radiogenic parent'],TX{:},FS{:}); set(gca,TL{:},TS{:});
    subplot(1,5,5)
    plot(mean(rid(2:end-1,2:end-1),2),Z(2:end-1).', 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis ij tight; box on;
    title(['radiogenic daughter'],TX{:},FS{:}); set(gca,TL{:},TS{:});
...
%     text(L/2,0.9*D,['time = ',num2str(time/hr,3),' [hr]'],TX{:},FS{:},'Color','LineStyle', LS{i},'Color', LC{1},'VerticalAlignment','middle','HorizontalAlignment','center');
%     axes(ax(12));
...
plot(CCx,TT, 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); axis tight; hold on; box on;
plot(CCm,TT, 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2);
perTs  = perT;
Tphs0s = Tphs0;
Tphs1s = Tphs1;
...
%     figure(8);  
%     subplot(4,1,1);
%     plot(hist.time/hr,hist.DM./hist.sumM, 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); hold on; axis tight; box on;
%     ylabel('consv. $M$',TX{:},FS{:}); set(gca,TL{:},TS{:},'XTickLabel',[]);
%     subplot(4,1,2);
%     plot(hist.time/hr,hist.DH./hist.sumH, 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); hold on; axis tight; box on;
%     ylabel('consv. $H$',TX{:},FS{:}); set(gca,TL{:},TS{:},'XTickLabel',[]);
%     subplot(4,1,3);
%     plot(hist.time/hr,hist.DC./hist.sumC, 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); hold on; axis tight; box on;
%     ylabel('consv. $C$',TX{:},FS{:}); set(gca,TL{:},TS{:},'XTickLabel',[]);
%     subplot(4,1,4);
%     plot(hist.time/hr,hist.DV./hist.sumV, 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); hold on; axis tight; box on;
%     ylabel('consv. $V$',TX{:},FS{:}); set(gca,TL{:},TS{:});
%     xlabel('Time [hr]',TX{:},FS{:});
% 
%     figure(9);  
%     subplot(4,1,1);
%     plot(hist.time/hr,hist.EM, 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); hold on; axis tight; box on;
%     ylabel('error $M$',TX{:},FS{:}); set(gca,TL{:},TS{:},'XTickLabel',[]);
%     subplot(4,1,2);
%     plot(hist.time/hr,hist.EH, 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); hold on; axis tight; box on;
%     ylabel('error $H$',TX{:},FS{:}); set(gca,TL{:},TS{:},'XTickLabel',[]);
%     subplot(4,1,3);
%     plot(hist.time/hr,hist.EC, 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); hold on; axis tight; box on;
%     ylabel('error $C$',TX{:},FS{:}); set(gca,TL{:},TS{:},'XTickLabel',[]);
%     subplot(4,1,4);
%     plot(hist.time/hr,hist.EV, 'LineStyle', LS{i},'Color', LC{1},'LineWidth',2); hold on; axis tight; box on;
